...
const ProfileInfo = () => (
  <div className="hidden xl:block xl:px-6 py-4">
    <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Doston</h1>
    ...
    <div className="space-y-4 mt-4 mb-2">
      ...
      <div className="flex items-center text-gray-700 dark:text-gray-200">
        ...
        <p className="px-2">
          Uzbekistan 🇺🇿
          <span className="align-middle flag-vn ml-1"></span>
        </p>
      </div>
      <div className="flex items-center text-gray-700 dark:text-gray-200">
        <svg
        ...
        <a className="px-2" href="mailto:wizardboydostonjon@gmail.com">
          wizardboydostonjon@gmail.com
        </a>
      </div>
      <div className="flex items-center text-gray-700 dark:text-gray-200">
        <svg
        ...
        <p className="px-2">
          <a
            target="_blank"
            href="https://github.com/Dostonlv"
            rel="noreferrer"
          ...
          <a
            target="_blank"
            href="https://twitter.com/Dostonlv"
            rel="noreferrer"
            className="hover:underline"
          >
            tw/Dostonlv

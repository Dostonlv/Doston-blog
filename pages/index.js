          ...
          <div className="xl:col-span-2 md:pr-8">
            ...
            <div className="text-lg leading-8 text-gray-600 dark:text-gray-400">
              <h1 className="text-neutral-900 dark:text-neutral-200">
                I'm <span className="font-medium">Doston</span> - an open-minded{' '}
              ...
              <p className="mt-4 mb-8">
                I started my coding journey in 2020 with C++ at lyceum and university .
                <br />
                I'm in love with the JS ecosystem, web dev, and eCommerce.
                <br />I created this blog to write what I have learned
              </p>
              <div className="flex flex-col space-y-1">
                <Link href="/blog" className="hover:underline">
                  <Twemoji emoji="memo" />
                  <span className="ml-2">My writings(in uzbek)</span>
                </Link>
              </div>
              <p className="my-8">
